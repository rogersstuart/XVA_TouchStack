...
struct uzlib_uncomp {
    ...
    uint32_t decompressed_len; /* total bytes decompressed (used for dest_ext lookups) */
...
uint32_t TINFCC uzlib_adler32(const void *datai, unsigned int length, uint32_t prev_sum);
/* crc is previous value for incremental computation, 0xffffffff initially */
uint32_t TINFCC uzlib_crc32(const void *datai, unsigned int length, uint32_t crc);
