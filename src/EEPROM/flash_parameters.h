...
//*** EFM8BB31F16G ***
// EFM8BB31F16G
#if defined EFM8BB31F16G

   #include <SI_EFM8BB3_Defs.h>
   #define ENABLE_VDDMON()
   #define DISABLE_WDT()      WDTCN = 0xDE; _nop_(); _nop_(); _nop_(); _nop_(); WDTCN = 0xAD;
   ...
   #define ENABLE_FL_MOD()    FLKEY  = 0xA5; FLKEY  = 0xF1;
...
// 64k Versions of C8051F04x
  ...
  ||(defined C8051F044)||(defined C8051F045)
   ...
   #define DISABLE_WDT()      WDTCN = 0xDE; WDTCN = 0xAD;
   #define SFRPAGE_SWITCH()   uint8_t pageSave = SFRPAGE; SFRPAGE = 0x00;
...
// 128k Versions of C8051F12x/13x
  ...
  ||(defined C8051F130)||(defined C8051F131)
   ...
   #define SFRPAGE_SWITCH()   uint8_t pageSave = SFRPAGE; SFRPAGE = 0x00;
   #define SFRPAGE_RESTORE()  SFRPAGE = pageSave;
   #define PSBANK_STORE()     uint8_t bankSave = PSBANK;
